...
namespace pruebas
{
    public partial class AggJugadores : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            if (agregar)
            {
                if (csDatos.InsertaJugador(txtIDJugador, Txtnombre, txtapellido, cmbsexo, dtpNacimiento, CmbPosicion, TxtNacionalidad, txtpeso, txtaltura, cmbpierna, nombreArchivo, img.FileName))
                {
